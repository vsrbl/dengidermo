...
const SERVER_VERSION = "v39.3.22r";
const SERVER_BUILD_ID = "v39.3.22r-20260525";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.3.22r protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
