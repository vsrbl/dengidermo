...
const SERVER_VERSION = "v39.3.11a";
const SERVER_BUILD_ID = "v39.3.11a-20260523";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.3.11a protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
