...
const SERVER_VERSION = "v39.1.2";
const SERVER_BUILD_ID = "v39.1.2-20260521";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.1.2 protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
