...
const SERVER_VERSION = "v39.3.14d";
const SERVER_BUILD_ID = "v39.3.14d-20260523";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.3.14d protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
