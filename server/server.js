...
const SERVER_VERSION = "v39.3.20e";
const SERVER_BUILD_ID = "v39.3.20e-20260524";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.3.20e protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
