...
const SERVER_VERSION = "v39.3.13b";
const SERVER_BUILD_ID = "v39.3.13b-20260523";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.3.13b protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
