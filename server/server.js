...
const SERVER_VERSION = "v39.0.0";
const SERVER_BUILD_ID = "v39.0.0-20260520";
...
server.listen(PORT, () => console.log(`nncckkrr signaling v39.0.0 protocol ${SIGNALING_PROTOCOL_VERSION} build ${SERVER_BUILD_ID} on ${PORT}`));
