...
node --check src/*.js
node -e "import('./shared/sim.v2-0-98.js').then(()=>console.log('sim import ok'))"
node -e "import('./src/audio.v2-0-98.js').then(()=>console.log('audio import ok'))"
zip -T nncckkrr_v2.0.98_wave_sting_restore.zip
```
