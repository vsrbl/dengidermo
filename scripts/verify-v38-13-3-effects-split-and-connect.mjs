...
await test('v38.13.3 versions are aligned across frontend package server and cache query strings', () => {
  ...
  assert.match(indexHtml, /main\.js\?v=38\.13\.3/);
  assert.match(indexHtml, /config\.js\?v=38\.13\.3/);
  assert.match(indexHtml, /style\.css\?v=38\.13\.3/);
});
...
console.log(`All ${results.length} v38.13.3 effects split and create-room checks passed`);
