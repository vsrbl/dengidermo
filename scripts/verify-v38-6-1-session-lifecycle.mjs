...
mustInclude(constants, 'VERSION = "v38.13.5"', "v38.13.5 frontend version");
...
mustInclude(server, 'nncckkrr signaling v38.13.5', "v38.13.5 server banner");

console.log("v38.13.5 session lifecycle checks passed");
