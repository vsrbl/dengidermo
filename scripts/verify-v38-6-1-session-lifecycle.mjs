...
mustInclude(constants, 'VERSION = "v38.6.3"', "v38.6.3 frontend version");
...
mustInclude(server, 'nncckkrr signaling v38.6.3', "v38.6.3 server banner");

console.log("v38.6.3 session lifecycle checks passed");
