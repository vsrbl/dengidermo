...
mustInclude(constants, 'VERSION = "v38.13.6"', "v38.13.6 frontend version");
...
mustInclude(server, 'nncckkrr signaling v38.13.6', "v38.13.6 server banner");

console.log("v38.13.6 session lifecycle checks passed");
