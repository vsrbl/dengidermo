# PATCH NOTES — v2.0.47 connection script hotfix
...
## Now
- `index.html` подключает `src/main.v2-0-47.js?v=2.0.47`.
- Все module filenames/imports обновлены на `v2-0-47`.
- Server/protocol/package version обновлены на `v2.0.47`.
