...
export const UPGRADES = [
  ...
  { id: 'debtengine',label: 'DEBT ENGINE',         tier: 2, cursed: true, desc: 'Большой урон и удача, но каждая следующая eligible-комната получает +1 фиксированный Static Rain stack. Не разгоняет уровень по числу ударов.', apply: s => { s.dmgMul *= 1.35; s.luck += 2; s.debtEngine += 1; } },
...
export function spinCasino(rng, stakeKey, luck, unlockedSkins = []) {
  ...
  const r = rng();
  // v2.0.79: skins were opening too slowly. SKN casino outcomes are now visible
