...
export const ACTIVE_CORES = {
  ...
  void_cut: {
    id: 'void_cut', label: 'VOID CUT', short: 'CUT', tone: 'purple', role: 'LINE FIELD',
    desc: 'Q протягивает от игрока к курсору грязную void-линию. Она остаётся в мире, режет врагов на линии, дамажит тех, кто пересекает её, и стирает вражеские пули.',
    upgrade: ['+длина линии', '+ширина реза', '+дольше поле и урон']
  },
  signal_spike: {
...
export const SKIN_PRESETS = [
  ...
  { id: 'jackpot_wound', name: 'JACKPOT WOUND', rarity: 'legendary', fill: '#160005', outline: '#ffd34d', barrel: '#ff3048', dash: '#ffd34d', dashAlt: '#ff3048', dashStyle: 'jackpot', legendarySfx: 'dash_jackpot', note: 'легендарная рана казино / jackpot dash + отдельный звук' },
  { id: 'dead_channel', name: 'DEAD CHANNEL', rarity: 'legendary', fill: '#000000', outline: '#f3f3f3', barrel: '#66f6ff', dash: '#f3f3f3', dashAlt: '#66f6ff', dashStyle: 'dead_channel', legendarySfx: 'dash_dead_channel', note: 'мёртвый канал / dead-TV dash + отдельный звук' }
];
