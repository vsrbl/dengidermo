...
import { ROOM_MODS, ROOM_SEQUENCE, SPECIAL_ROOMS } from './data.v2-0-93.js';
...
export function generateRoom(seed, runDepth, loopIndex, override = null) {
  ...
  // v2.0.93: Casino Virus still uses normal director pressure while the 3 reels are pending.
