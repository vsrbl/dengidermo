...
import {
  ...
  WEAPON_CHEST_REWARDS, HERO_UPGRADES,
  rollUpgradeChoices, defaultStats, spinCasino, UPGRADE_LABELS
} from './data.v2-0-13.js';
import { generateRoom, spawnPoint, enemySpawnPoint, portalSpot, mulberry32, WALL_T } from './mapgen.v2-0-13.js';
...
export function resetRun(run, players) {
  ...
  for (const p of players.values()) {
    ...
    p.dashCharges = 1; p.activeCd = 0; p.activeBuffT = 0; p.alive = true; p.hp = PLAYER_HP; p.offer = null; p.weaponChestOffer = null;
  }
