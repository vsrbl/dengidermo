...
export const WEAPONS = {
  ...
  seeker: {
    ...
    cooldown: 0.72, pellets: 1, spread: 0.025, dmg: 20, speed: 340, life: 1.55, maxDist: 620, size: 5, homing: 4.6, knock: 36
  },
  rocketgun: {
...
export const UPGRADES = [
  ...
  { id: 'bullet_chain', label: 'BULLET CHAIN +1', tier: 1, branch: 'ALL', desc: 'WPN-эффект: попадание оружием перескакивает на ближайшего врага. Каждый стак добавляет +1 прыжок цепи; очень долгая прокачка может дотянуть цепь до огромной толпы.', apply: s => { s.bulletChain += 1; } },
...
export const WEAPON_CHEST_REWARDS = [
  ...
  { id: 'bullet_chain', kind: 'weapon_upgrade', upgrade: 'bullet_chain', label: 'BULLET CHAIN +1', desc: 'Попадание оружием перебрасывает часть урона и elemental-статусов на ближайшего врага. Стакается: больше уровней — длиннее цепочка.' },
