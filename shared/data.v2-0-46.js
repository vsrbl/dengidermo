...
export const ACTIVE_CORES = {
  ...
  void_cut: {
    ...
    desc: 'Q выпускает из игрока быстрый тонкий void-лазер в сторону курсора. Это не широкая полоса, а минималистичный цифровой луч в стиле игры: тонкая линия, белое ядро, purple signal glow. Луч режет врагов на линии и стирает вражеские пули.',
    upgrade: ['+длина луча', '+урон лазера', '+длительность луча']
  },
  signal_spike: {
