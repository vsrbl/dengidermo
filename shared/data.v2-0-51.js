...
export const ACTIVE_CORES = {
  ...
  void_cut: {
    id: 'void_cut', label: 'VOID CUT', short: 'CUT', tone: 'purple', role: 'THIN LASER',
    desc: 'Q выпускает из игрока тонкий void-лазер в сторону курсора. Минимализм: почти одна грязная белая линия с лёгким purple signal, без толстого поля и лишних частиц. Луч режет врагов на линии и стирает вражеские пули.',
    upgrade: ['++заметная длина луча', '+урон лазера', '++заметная длительность луча']
  },
  signal_spike: {
