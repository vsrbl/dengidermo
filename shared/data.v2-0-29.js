...
export const ACTIVE_CORES = {
  blood_ring: {
    ...
    desc: 'Долгая follow-зона вокруг игрока: стартует компактно, раздувается, тикает уроном и реально даёт место для игры вокруг себя.',
  ...
  field_snap: {
    ...
    desc: 'Мощно стягивает врагов и pickups к игроку, затем оставляет короткое lingering-поле, которое продолжает тянуть и глушить темп.',
    upgrade: ['+большой радиус', '+сила стяжки', '+дольше lingering']
  },
  bullet_freeze: {
    id: 'bullet_freeze', label: 'BULLET FREEZE', short: 'FREEZE', tone: 'cyan', role: 'BULLET CONTROL',
    desc: 'Длинная холодная follow-аура вокруг игрока: резко гасит вражеские пули и сильно замедляет врагов внутри зоны.',
    upgrade: ['+большой радиус', '+длительность', '+сильнее стоп']
  },
  shell_ripper: {
  ...
  void_cut: {
    id: 'void_cut', label: 'VOID CUT', short: 'CUT', tone: 'purple', role: 'PHASE DASH',
    desc: 'Q делает фазовый разрез по направлению aim: игрок проскальзывает сквозь толпу, режет врагов на линии и стирает часть вражеских пуль.',
    upgrade: ['+длина разреза', '+ширина линии', '+урон и invuln']
  },
  signal_spike: {
    id: 'signal_spike', label: 'SIGNAL SPIKE', short: 'SPIKE', tone: 'cyan', role: 'DEPLOY NODE',
    desc: 'Ставит грязный квадратный шип-антенну в точке aim. Шип долго пульсирует, бьёт врагов, глушит пули и держит опасный участок карты.',
    upgrade: ['+дальность постановки', '+радиус шипа', '+длительность и урон']
  },
  black_box: {
    id: 'black_box', label: 'BLACK BOX', short: 'BOX', tone: 'purple', role: 'SAFE NOISE',
    desc: 'Создаёт вокруг игрока чёрный сбой: враги внутри теряют темп, их выстрелы глохнут, а incoming bullets быстро разваливаются.',
    upgrade: ['+радиус сбоя', '+длительность', '+сильнее bullet decay']
  },
  debt_pulse: {
    id: 'debt_pulse', label: 'DEBT PULSE', short: 'DEBT', tone: 'red', role: 'RISK BURST',
    desc: 'Большая красная волна: мощно ранит и раскрывает врагов, но иногда включает STATIC DEBT. Это рискованная panic-кнопка для сложных комнат.',
...
export const ACTIVE_MUTATIONS = {
  ...
  casino: { id: 'casino', label: 'CASINO', tone: 'green', role: 'ROLL', desc: 'Добавляет roll: jackpot может дать GLD/HEA/EXP, но иногда создаёт STATIC DEBT.' },
  ...
  chain: { id: 'chain', label: 'CHAIN', tone: 'cyan', role: 'JUMP DMG', desc: 'После каста сигнал прыгает между ближайшими врагами: несколько целей получают дополнительный урон и микростан-замедление.' },
...
export const SKIN_PRESETS = [
  { id: 'terminal_mint', name: 'TERMINAL MINT', rarity: 'basic', fill: '#f3f3f3', outline: '#00ff66', barrel: '#00ff66', note: 'чистый базовый сигнал' },
  { id: 'debt_red', name: 'DEBT RED', rarity: 'basic', fill: '#120406', outline: '#ff3048', barrel: '#ff3048', note: 'долговой базовый сигнал' },
  { id: 'void_cyan', name: 'VOID CYAN', rarity: 'uncommon', fill: '#061114', outline: '#66f6ff', barrel: '#f3f3f3', note: 'холодная пустота / мягкий фазовый шум' },
  { id: 'casino_gold', name: 'CASINO GOLD', rarity: 'uncommon', fill: '#171104', outline: '#ffd34d', barrel: '#00ff66', note: 'выигрышная рамка / нервный ствол' },
  { id: 'bruise_purple', name: 'BRUISE PURPLE', rarity: 'uncommon', fill: '#100617', outline: '#b45cff', barrel: '#ff3048', note: 'синяк сигнала / красный разрез' },
  { id: 'bone_static', name: 'BONE STATIC', rarity: 'rare', fill: '#d8d0bd', outline: '#6f6f6f', barrel: '#66f6ff', note: 'костяной шум / scanline-внутрянка' },
  { id: 'black_lime', name: 'BLACK LIME', rarity: 'rare', fill: '#020202', outline: '#a6ff00', barrel: '#a6ff00', note: 'кислотный крест / жёсткая рамка' },
  { id: 'bad_tv', name: 'BAD TV', rarity: 'rare', fill: '#ffffff', outline: '#111111', barrel: '#ff3048', note: 'пересвет / TV-срыв / дёрганая рамка' },
  { id: 'red_static', name: 'RED STATIC', rarity: 'superrare', fill: '#060101', outline: '#ff3048', barrel: '#66f6ff', note: 'красные помехи / циановая игла' },
  { id: 'mirror_coin', name: 'MIRROR COIN', rarity: 'superrare', fill: '#090909', outline: '#ffd34d', barrel: '#ffd34d', note: 'ложная монета / зеркальная обводка' },
  { id: 'terminal_ghost', name: 'TERMINAL GHOST', rarity: 'superrare', fill: '#e8fff2', outline: '#66f6ff', barrel: '#00ff66', note: 'призрачный терминал / фаза' },
  { id: 'jackpot_wound', name: 'JACKPOT WOUND', rarity: 'legendary', fill: '#160005', outline: '#ffd34d', barrel: '#ff3048', note: 'легендарная рана казино / живой выигрыш' },
  { id: 'dead_channel', name: 'DEAD CHANNEL', rarity: 'legendary', fill: '#000000', outline: '#f3f3f3', barrel: '#66f6ff', note: 'мёртвый канал / белая оболочка / холодная игла' }
];
...
export function spinCasino(rng, stakeKey, luck, unlockedSkins = []) {
  ...
  const r = rng();
  const skinOdds = (stakeKey === 'high' ? 0.017 : stakeKey === 'mid' ? 0.011 : 0.006) + l * 0.05;
  const odds = [
    ['JCK', 0.012 + l * 0.35],
    ['WPN', 0.040 + l * 0.72],
    ['ABL', 0.050 + l * 0.72],
