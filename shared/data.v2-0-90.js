...
export const UPGRADES = [
  ...
  { id: 'dashclone', label: 'DASH ECHO BURST',    tier: 1, branch: 'DASH', desc: 'В начале рывка остаётся короткий эхо-взрыв, который ранит ближайших врагов.', apply: s => { s.dashClone += 1; } },
...
export const ABILITY_CHEST_REWARDS = [
  ...
  { id: 'abl_dashclone', kind: 'ability_upgrade', upgrade: 'dashclone', label: 'DASH ECHO BURST', desc: 'В начале рывка остаётся короткий эхо-взрыв, который ранит ближайших врагов.' },
...
export function spinCasino(rng, stakeKey, luck, unlockedSkins = []) {
  ...
  const r = rng();
  // v2.0.90: skins were opening too slowly. SKN casino outcomes are now visible
