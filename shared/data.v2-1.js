...
export const ENEMIES = {
  ...
  slot_mob: { label: 'SLT', hp: 92, spd: 118, size: 44, dmg: 15, slotMob: true, touch: true, fireCd: 1.25, bulletSpd: 250, xp: 26, gld: 32, score: 5, role: 'casino overload process', combo: 'slot corruption' },
