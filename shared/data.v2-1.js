...
export const ENEMIES = {
  ...
  slot_mob: { label: 'SLT', hp: 9200, spd: 236, size: 44, dmg: 15, slotMob: true, touch: true, fireCd: 0.62, bulletSpd: 500, xp: 26, gld: 32, score: 5, role: 'casino overload process', combo: 'slot corruption' },
