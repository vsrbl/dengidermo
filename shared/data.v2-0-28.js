...
export const ACTIVE_CORES = {
  blood_ring: {
    ...
    desc: 'Длинная квадратная аура вокруг игрока. Начинается компактной, растёт во время работы и тикает уроном рядом.',
    upgrade: ['сильно +радиус', 'дольше аура', 'сильнее тики']
  },
  field_snap: {
    id: 'field_snap', label: 'FIELD SNAP', short: 'SNAP', tone: 'cyan',
    desc: 'Сильно стягивает врагов и pickups к игроку, затем оставляет короткую грязную гравитационную помеху.',
    upgrade: ['сильно +радиус', 'сильнее стяжка', 'дольше помеха']
  },
  bullet_freeze: {
    id: 'bullet_freeze', label: 'BULLET FREEZE', short: 'FREEZE', tone: 'cyan',
    desc: 'Долгая freeze-аура вокруг игрока: тормозит/стирает вражеские пули и сильно замедляет врагов внутри.',
    upgrade: ['сильно +радиус', 'дольше аура', 'жёстче freeze']
  },
  shell_ripper: {
    id: 'shell_ripper', label: 'SHELL RIPPER', short: 'RIP', tone: 'purple',
    desc: 'Бьёт по armor/shell вокруг игрока. Если брони нет — вешает EXPOSED: враг получает больше урона несколько секунд.',
    upgrade: ['сильно +радиус', '+shell damage', 'дольше EXPOSED']
  }
};

export const ACTIVE_MUTATIONS = {
  static: { id: 'static', label: 'STATIC', tone: 'cyan', desc: 'После каста остаётся более долгое квадратное поле: враги и пули в нём замедляются.' },
  blood: { id: 'blood', label: 'BLOOD', tone: 'red', desc: 'Добавляет кровавый урон. Сильнее, когда рядом много врагов; иногда стоит HP.' },
  echo: { id: 'echo', label: 'ECHO', tone: 'purple', desc: 'Повторяет часть активки через заметную задержку, слабее, но читаемо и хаотично.' },
  ...
  void: { id: 'void', label: 'VOID', tone: 'purple', desc: 'После каста игрок получает более длинный phase/invuln и грязный циановый разрез.' },
