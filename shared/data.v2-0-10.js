...
export const WEAPONS = {
  shotgun: {
    ...
    cooldown: 0.55, pellets: 6, spread: 0.38, dmg: 7, speed: 620, life: 0.45, size: 5, knock: 95, recoil: 7
  },
  seeker: {
    id: 'seeker', label: 'SEK', name: 'SEEKER',
    cooldown: 0.34, pellets: 1, spread: 0.05, dmg: 13, speed: 480, life: 1.6, size: 6, homing: 7.5, knock: 55, recoil: 4
  },
  rocketgun: {
    id: 'rocketgun', label: 'RKT', name: 'ROCKETGUN',
    cooldown: 0.92, pellets: 1, spread: 0.02, dmg: 32, speed: 360, life: 2.0, size: 8, aoe: 85, knock: 180, recoil: 13, detonateDist: 520
  }
};
