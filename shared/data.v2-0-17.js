...
export const SPAWN_POOLS = [
  ...
  ['grunt', 'runner', 'shooter', 'charger', 'bomber', 'bouncer', 'tank', 'glitch', 'anchor', 'leech', 'pulse', 'warden'],
  ['grunt', 'runner', 'shooter', 'charger', 'bomber', 'bouncer', 'tank', 'glitch', 'echo', 'orbiter', 'anchor', 'splitter', 'prism', 'pulse', 'leech', 'warden', 'herald']
];
...
export const WEAPON_BRANCHES = ['SHG', 'SEK', 'RKT'];
...
export const WEAPON_CHEST_REWARDS = [
  { id: 'weapon_seeker', kind: 'weapon', weapon: 'seeker', label: 'SEK WEAPON', desc: 'Открывает SEEKER: медленный самонаводящийся цифровой снаряд.' },
  ...
  { id: 'shg_bounce', kind: 'weapon_upgrade', upgrade: 'shg_bounce', reqWeapon: 'shotgun', label: 'SHG RICOCHET +1', desc: 'Апгрейд SHG: дробины получают дополнительный отскок.' },
