...
export const ACTIVE_CORES = {
  ...
  bullet_freeze: {
    ...
    desc: 'Холодная follow-аура вокруг игрока: статичный квадратный радиус, мягче гасит пули и замедляет врагов внутри.',
  ...
  signal_spike: {
    ...
    desc: 'Ставит квадратный шип-антенну в точке aim. Вокруг объекта держится стабильная aura-зона, которая наносит урон и глушит пули.',
