  ...
  play(type) {
    ...
    switch (type) {
      ...
      case 'dash':
        ...
        break;
      case 'dash_jackpot':
        // legendary JACKPOT WOUND dash: slot-machine bite + red cut
        this.tone(260, 0.042, 'square', 0.070, 1.8);
        this.tone(520, 0.038, 'square', 0.050, 1.35, 0.035);
        this.tone(1040, 0.032, 'square', 0.040, 0.75, 0.070);
        this.noise(0.026, 0.030, 3600, 10, 0.012);
        break;
      case 'dash_dead_channel':
        // legendary DEAD CHANNEL dash: cut-out TV sync loss
        this.tone(96, 0.060, 'square', 0.055, 0.55);
        this.tone(1440, 0.028, 'square', 0.038, 0.50, 0.010);
        this.tone(1880, 0.024, 'square', 0.026, 0.68, 0.044);
        this.noise(0.045, 0.036, 5200, 14);
        break;
      case 'gld':
