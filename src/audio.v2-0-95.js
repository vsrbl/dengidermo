...
export class AudioBus {
  ...
  play(type) {
    ...
    switch (type) {
      case 'shot_shg':
        ...
        break;
      case 'shot_sek':
        // v2.0.95: SEEKER is 50% quieter and pitched higher; still dry/terminal, no bubble chirp.
  ...
  musicRootFor(context = {}) {
    // v2.0.95: keep every music layer locked to the same bass center.
  ...
  handleFx(f, info = {}) {
    ...
    switch (f.t) {
      ...
      case 'enemy_combo': break;
      case 'director_room': break;
      case 'director_wave': break;
