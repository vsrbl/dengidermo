...
import { Net, VERSION, BUILD_ID, PROTOCOL, GAME_SPEED } from './net.v2-0-79.js';
import { Input } from './input.v2-0-79.js';
import { GameState, P } from './state.v2-0-79.js';
import { Effects } from './effects.v2-0-79.js';
import { Renderer } from './render.v2-0-79.js';
import { Hud } from './hud.v2-0-79.js';
import { AudioBus } from './audio.v2-0-79.js';
import { SKIN_PRESETS, SKIN_RARITIES, DEFAULT_UNLOCKED_SKINS, ACTIVE_CORES, ACTIVE_MUTATIONS, ROOM_MODS, SPECIAL_ROOMS, ROOM_SEQUENCE } from '../shared/data.v2-0-79.js';
import { setupLanguageButtons, onLangChange, t, skinNote, labelStatus, getLang, locRole, locAction } from './i18n.v2-0-79.js';
