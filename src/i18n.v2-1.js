...
Object.assign(EN_UPGRADE, {
  impact_damage: 'Increases takeoff, landing, and impact-field damage.', impact_radius: 'Each stack adds 10% of the base takeoff and landing hit radius.', impact_distance: 'Each stack increases jump range by 20%. Jumps are ready immediately after landing.', impact_stun: 'Landing stuns threats; repeats extend the lock.', impact_afterfield: 'Landing leaves a short damaging field; repeats strengthen it.', impact_rebound: 'Unlocks the wall-rebound damage multiplier, retains more inertia, and slightly extends airtime.', impact_wall_unlock: 'Unlocks a separate LMB module that places temporary square blocks.', impact_wall_count: 'Allows one more owned block at once.', impact_wall_duration: 'Owned square blocks persist longer.', impact_push_unlock: 'Unlocks RMB PUSH: aim directly at a nearby owned block to launch it away from the cursor contact point.', impact_push_range: 'Increases PUSH selection reach and block travel distance without a stack limit.', impact_push_damage: 'Increases moving-block damage without a stack limit.', impact_push_cooldown: 'Shortens PUSH recovery without a stack limit.', impact_push_bounce: 'Moving blocks rebound from walls instead of stopping at the first impact.', impact_push_multiplier: 'Each wall rebound adds more damage to the moving block without a stack limit.'
});
