...
const RU = {
  ui: {
    ...
    betTitle: 'ТЕРМИНАЛ СТАВОК', betBody: 'Риск за GLD: ставка списывается, барабаны крутятся, результат даёт награду или опасность.',
    ...
    statusConnecting: 'ПОДКЛЮЧЕНИЕ…', statusOnline: 'В СЕТИ', statusNetReady: 'СЕТЬ ГОТОВА', statusNetSleep: 'СЕТЬ ПРОСЫПАЕТСЯ · СОЛО ГОТОВО', statusNetDown: 'СЕТЬ НЕДОСТУПНА · СОЛО ГОТОВО',
...
const RU_LABEL = {
  ...
  'QUARANTINE BUFFER': 'КАРАНТИННЫЙ БУФЕР', 'EMERGENCY CLEANSE': 'АВАРИЙНАЯ ОЧИСТКА', 'PAYOUT MIRROR': 'ПОДМЕНА ВЫПЛАТЫ', 'FALSE ZERO': 'ЛОЖНЫЙ НОЛЬ', 'DEAF COMMAND': 'ГЛУХАЯ КОМАНДА', 'HUNT ROUTE': 'МАРШРУТ ОХОТЫ', 'RED OVERDRIVE': 'КРАСНЫЙ РАЗГОН', 'AIM GLITCH': 'СБОЙ НАВЕДЕНИЯ', 'INCOMPLETE DELETE': 'НЕПОЛНОЕ УДАЛЕНИЕ', 'INSURANCE PROCESS': 'СТРАХОВОЙ ПРОЦЕСС', 'THREAT SIGNATURE': 'СИГНАТУРА УГРОЗЫ',
