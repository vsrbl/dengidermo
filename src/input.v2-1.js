// terminal casino roguelike input: WASD by event.code, mouse aim, edge-triggered actions
export class Input {
  constructor(canvas) {
    this.keys = new Set();
    ...
    window.addEventListener('keydown', (e) => {
      ...
      if (c === 'F2') { e.preventDefault(); this.devToggleEdge = true; return; }
      ...
      if (c === 'Space') { e.preventDefault(); this.spaceEdge = true; }
    });
  ...
  takeSpace() { const v = this.spaceEdge; this.spaceEdge = false; return v; }
  ...
  takeDevToggle() { const v = this.devToggleEdge; this.devToggleEdge = false; return v; }
}
