...
export class AudioBus {
  constructor() {
    ...
    this.prio = {
      ...
      casino_static: 8, casino_lose: 7, casino_weapon: 7, casino_ability: 7, casino_win: 6,
  ...
  handleFx(f, info = {}) {
    ...
    switch (f.t) {
      ...
      case 'casino':
        if (mine) {
          if (f.outcome === 'JCK') this.play('jackpot');
          else if (f.outcome === 'LOSE') this.play('casino_lose');
          else if (f.outcome === 'STC') this.play('casino_static');
          else if (f.outcome === 'WPN') this.play('casino_weapon');
          else if (f.outcome === 'ABL') this.play('casino_ability');
          else this.play('casino_win');
        }
        break;
