...
export const RARITY_META = Object.freeze({
  common: { id: "common", label: "COMMON", weight: 1, color: "#d8d8d8", uiClass: "common", revealDurationMs: 220, revealDelayMs: 0, revealRise: 7 },
  uncommon: { id: "uncommon", label: "UNCOMMON", weight: 0.64, color: "#2dd4bf", uiClass: "uncommon", revealDurationMs: 220, revealDelayMs: 0, revealRise: 7 },
  rare: { id: "rare", label: "RARE", weight: 0.32, color: "#6f8cff", uiClass: "rare", revealDurationMs: 220, revealDelayMs: 0, revealRise: 7 },
  epic: { id: "epic", label: "EPIC", weight: 0.16, color: "#c45cff", uiClass: "epic", revealDurationMs: 220, revealDelayMs: 0, revealRise: 7 },
  legendary: { id: "legendary", label: "LEGENDARY", weight: 0.075, color: "#ff9a1f", uiClass: "legendary", revealDurationMs: 220, revealDelayMs: 0, revealRise: 7 },
  corrupted: { id: "corrupted", label: "CORRUPTED", weight: 0.045, color: "#ff3048", uiClass: "corrupted", revealDurationMs: 220, revealDelayMs: 0, revealRise: 7, reservedFor: "future cursed upgrades" }
});
