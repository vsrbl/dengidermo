...
export class LocalRoom {
  ...
  addHost(playerId, name) {
    this.hostId = playerId;
    const p = createPlayer(playerId, name, 0);
    this.players.set(playerId, p);
    this.onLocal(this.welcomeMsg(playerId));
  }

  addGuest(guestId, name, channel) {
