...
import { P, ENEMY_KINDS, ENEMY_LABELS } from './state.v2-0-50.js';
...
export class Renderer {
  ...
  draw(state, effects, view, myPos, mouse, now) {
    ...
    for (const e of view.enemies) {
      const [eid, kindIdx, ex, ey, hp01, size, st, elite, dirX, dirY, shellPct = 0, shellLock = 0, linkId = '', shellType = '', exposed = 0, frozen = 0, burn = 0, poison = 0, chill = 0] = e;
