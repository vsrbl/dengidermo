...
import { VERSION, BUILD_ID, PROTOCOL, GAME_SPEED } from '../shared/protocol.v2-1.js';
import { LocalRoom } from './local.v2-1.js';

export { VERSION, BUILD_ID, PROTOCOL, GAME_SPEED };
...
export class Net {
  ...
  sendContractPick(choice) { this._game({ t: 'contract_pick', choice: Number(choice) | 0 }, true); }
