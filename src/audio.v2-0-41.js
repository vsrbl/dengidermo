  ...
  play(type) {
    ...
    switch (type) {
      case 'shot_shg':
        ...
        break;
      case 'shot_sek':
        // higher-pitched SHG-like dry snap: chunky square attack + bright terminal crack, no chirp/bubble.
        this.tone(245, 0.046, 'square', 0.050, 0.58);
        this.tone(560, 0.030, 'square', 0.032, 0.48, 0.005);
        this.noise(0.032, 0.036, 2200, 5.2);
        this.noise(0.014, 0.016, 5200, 12, 0.006);
        break;
      case 'shot':
