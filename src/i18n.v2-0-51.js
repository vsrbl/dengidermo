...
const EN_UPGRADE = {
  ...
  abl_dash: 'Adds one dash charge.', abl_voidstep: 'Dash leaves a cyan cut line that damages enemies.', abl_dashcut: 'Dash stuns enemies near its path. More stacks increase stun radius and duration.', abl_dashclone: 'Dash leaves an echo burst at the start point.', abl_speed: 'Increases movement speed.', abl_dashflow: 'Dash charges recover faster.'
};
