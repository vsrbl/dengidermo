...
import { P } from './state.v2-0-5.js';

const $ = id => document.getElementById(id);
const MOD_LABELS = { blackout: 'BLACKOUT', static_rain: 'STATIC RAIN', greed: 'GREED SIGNAL', debt_floor: 'DEBT FLOOR', hunter_contract: 'HUNTER CONTRACT', casino_virus: 'CASINO VIRUS', mirror_room: 'MIRROR ROOM' };
...
export class Hud {
  ...
  openInstall(choices, pending) {
    ...
    box.innerHTML = '';
    const CURSED = ['overload', 'gamble', 'debtengine'];
    const LABELS = {
      ...
      goldgun: 'GLD ON KILL +40%',
      shg_bounce: 'SHG RICOCHET +1', shg_teeth: 'SHG TEETH +2 PELLETS',
      sek_split: 'SEK SPLIT ON KILL', sek_chain: 'SEK CHAIN LOCK',
      rkt_cluster: 'RKT CLUSTER +2', rkt_mines: 'RKT STATIC MINES',
      voidstep: 'DASH: VOID STEP', dashcut: 'DASH CUTS BULLETS', dashclone: 'DASH CLONE',
      q_snap: 'Q: FIELD SNAP', q_blood: 'Q: BLOOD PULSE', q_over: 'Q: OVERCLOCK',
      droneproc: 'DRONES COPY PROC', orbreflect: 'ORBITALS REFLECT', debtengine: 'DEBT ENGINE',
      overload: 'DMG +50% / HP -15', gamble: 'LUCK +3 / SPD -10%'
    };
