...
const RU = {
  ui: {
    ...
    modsTitle: 'ПРАВИЛА КОМНАТЫ', modsBody: 'Особые правила комнаты: темнота, статический дождь, долг, казино-вирус, зеркало и другие события.',
    ...
    statusConnecting: 'подключение…', statusOnline: 'на связи', statusNetReady: 'сеть готова', statusNetSleep: 'сеть просыпается · СОЛО доступно сразу', statusNetDown: 'сеть недоступна · СОЛО работает',
    updateRequired: 'обнови страницу: версия игры устарела', roomCode4: 'код комнаты — 4 символа', roomNotFound: 'комната не найдена', roomFull: 'комната заполнена (4/4)', lostConnection: 'связь потеряна — обнови страницу',
    ...
    betPrompt: 'E — BET TERMINAL', betInspect: 'Казино-терминал: E открывает ставки LOW/MID/HIGH.',
    ...
    contract: 'КОНТРАКТ', contractBody: 'убей отмеченную цель быстро', contractDone: 'КОНТРАКТ ВЫПОЛНЕН', contractDoneBody: 'редкий апгрейд установлен', contractFail: 'КОНТРАКТ ПРОВАЛЕН', contractFailBody: 'цель стала сильнее',
...
const EN = {
  ui: {
    ...
    modsTitle: 'ROOM RULES', modsBody: 'Special room rules: darkness, static rain, debt, casino virus, mirror events, and more.',
    ...
    statusConnecting: 'connecting…', statusOnline: 'online', statusNetReady: 'network ready', statusNetSleep: 'network waking · SOLO is available now', statusNetDown: 'network unavailable · SOLO works',
    updateRequired: 'refresh page: game build is outdated', roomCode4: 'room code is 4 symbols', roomNotFound: 'room not found', roomFull: 'room is full (4/4)', lostConnection: 'connection lost — refresh page',
    ...
    betPrompt: 'E — BET TERMINAL', betInspect: 'Casino terminal: E opens LOW/MID/HIGH bets.',
    ...
    contract: 'CONTRACT', contractBody: 'kill the marked target quickly', contractDone: 'CONTRACT DONE', contractDoneBody: 'rare upgrade installed', contractFail: 'CONTRACT FAILED', contractFailBody: 'target became stronger',
...
const EN_UPGRADE = {
  ...
  abl_dash: 'Adds one dash charge.', abl_voidstep: 'Dash leaves a cyan cut line that damages enemies.', abl_dashcut: 'Dash erases enemy bullets near its path.', abl_dashclone: 'Dash leaves an echo burst at the start point.', abl_speed: 'Increases movement speed.', abl_dashflow: 'Dash charges recover faster.'
};
