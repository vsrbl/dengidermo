...
const MOD_LABELS_RU = {
  ...
  shell_market: 'БИРЖА ЩИТОВ', echo_walls: 'ЭХО-ВЫСТРЕЛЫ', anchor_gravity: 'ЯКОРЯ ГРАВИТАЦИИ', static_wires: 'СТАТИК-ПРОВОДА', hunted_exit: 'ОХОТА У ВЫХОДА', skin_cache: 'СКИН-ТАЙНИК'
};
const TAG_RU = {
