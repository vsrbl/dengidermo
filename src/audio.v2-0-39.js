  ...
  play(type) {
    ...
    switch (type) {
      case 'shot_shg':
        ...
        break;
      case 'shot_sek':
        // compact digital lock-on tick: no bubble, no wet chirp, less annoying in repeated fire
        this.noise(0.010, 0.012, 5200, 18);
        this.tone(1520, 0.014, 'square', 0.030, 0.62, 0.004);
        this.tone(980, 0.018, 'square', 0.022, 0.74, 0.018);
        this.tone(430, 0.018, 'square', 0.018, 1.18, 0.034);
        break;
      case 'shot':
