      ...
      case 'denied':
        if (mine) {
          if (typeof f.x === 'number' && typeof f.y === 'number') {
            ...
            this.float(f.x, f.y - 34, f.cost ? `NO GLD ${f.have}/${f.cost}` : t('denied'), '#ff3048', 14);
          }
      ...
      case 'active_denied':
        if (mine) {
          if (typeof f.x === 'number' && typeof f.y === 'number') {
            ...
            this.float(f.x, f.y - 34, t('noActive'), '#66f6ff', 13);
          }
          this.kick(3);
        }
        break;
      case 'portal_open':
        // v2.0.79: portal open is a hard square signal burst, never a round ring.
