...
const RU = {
  ui: {
    ...
    modsTitle: 'ПРАВИЛА КОМНАТЫ', modsBody: 'Особые правила комнаты: темнота, статический дождь, долг, казино-вирус, зеркало, chill-room и другие события.',
...
const EN = {
  ui: {
    ...
    modsTitle: 'ROOM RULES', modsBody: 'Special room rules: darkness, static rain, debt, casino virus, mirror events, chill rooms, and more.',
...
const EN_UPGRADE = {
  ...
  abl_dash: 'Adds one dash charge.', abl_voidstep: 'Dash path becomes a void rift. Enemies along the full dash take heavy damage. Stacks increase width and damage.', voidstep: 'Dash path becomes a void rift. Enemies along the full dash take heavy damage. Stacks increase width and damage.', abl_dashcut: 'Dash stuns enemies near its path. More stacks increase stun radius and duration.', abl_dashclone: 'Dash leaves an echo burst at the start point.', abl_speed: 'Increases movement speed.', abl_dashflow: 'Dash charges recover faster.'
};
