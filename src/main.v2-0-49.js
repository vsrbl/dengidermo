...
import { Net, VERSION, GAME_SPEED } from './net.v2-0-49.js';
import { Input } from './input.v2-0-49.js';
import { GameState, P } from './state.v2-0-49.js';
import { Effects } from './effects.v2-0-49.js';
import { Renderer } from './render.v2-0-49.js';
import { Hud } from './hud.v2-0-49.js';
import { AudioBus } from './audio.v2-0-49.js';
import { SKIN_PRESETS, SKIN_RARITIES, DEFAULT_UNLOCKED_SKINS, ACTIVE_CORES, ACTIVE_MUTATIONS } from '../shared/data.v2-0-49.js';
...
function updateSkinPreview() {
  ...
  if (note) {
    ...
    note.textContent = `${rarity.label} · ${status}`;
  }
}
